...
<body class="bg-[#FAF9F5] min-h-screen flex items-center justify-center p-4 md:p-4 overflow-x-hidden">
    ...
    <div class="w-full max-w-5xl bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] overflow-hidden relative"
         ...
         x-data="{ showPassword: false, form: { email: '', password: '' } }">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 min-h-[600px] relative">
            ...
            <div class="lg:col-span-7 relative bg-cover bg-center flex flex-col justify-between p-8 md:p-12 text-white overflow-hidden"
                ...
                <div class="relative z-10 my-auto py-12">
                    <h1 class="font-serif text-5xl md:text-7xl font-bold tracking-tight leading-none mb-3">SIGN<br>IN</h1>
                    <p class="text-sm text-emerald-100/90 font-light">Masuk ke akun Anda untuk melanjutkan.</p>
                </div>

                <div class="relative z-10 flex items-center justify-between">
                    <a href="{{ route('register') }}" class="group flex items-center space-x-2 text-xs tracking-widest uppercase font-semibold text-white hover:text-emerald-300 transition-colors">
            ...
            <div class="lg:col-span-5 bg-[#1B3022] p-8 md:p-10 flex flex-col justify-center relative text-white"
                ...
                <p class="text-xs text-emerald-200/70 mb-8">Masuk ke akun Anda untuk melanjutkan.</p>
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" required class="w-full bg-white text-zinc-800 text-sm px-4 py-3 rounded-full focus:outline-none focus:ring-2 focus:ring-emerald-400 shadow-inner">
                    </div>

                    <div class="space-y-1.5 relative">
                        <label class="block text-[10px] font-bold tracking-widest uppercase text-emerald-200/80">Password</label>
                        <div class="relative">
                            <input :type="showPassword ? 'text' : 'password'" name="password" required class="w-full bg-white text-zinc-800 text-sm px-4 py-3 rounded-full focus:outline-none focus:ring-2 focus:ring-emerald-400 shadow-inner pr-12">
                    ...
                    <div class="pt-4 flex items-center justify-between">
                        ...
                        <a href="{{ route('register') }}" class="text-[11px] text-emerald-200/60 hover:text-white underline transition-colors">
                            Need an account?
                        </a>
                    </div>
